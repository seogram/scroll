...
/**
 * scroll speed, default value 1500
 *  scroll type 'easeOutSine', 'easeInOutSine' or 'easeInOutQuint', default value easeInOutQuint
 */
...
export function scrollSpy(menu, speed, easing) {
